...
# Exit behaviour: a single exit closes the terminal instead of leaving the
# client attached to a destroyed session. Keep detached sessions alive after a
# terminal closes (do not destroy unattached sessions).
